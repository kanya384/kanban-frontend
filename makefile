...
genapi: ## generates module from openapi spec api file is here https://git.g-n.ru/golang-amo/backend/-/raw/main/internal/delivery/swagger/docs/swagger.json
	@openapi-generator-cli generate -i ./src/api/swagger.json -o ./src/api/generated -g typescript-axios --additional-properties=supportsES6=true,npmVersion=6.9.0,typescriptThreePlus=true --skip-validate-spec
.PHONY: genapi
